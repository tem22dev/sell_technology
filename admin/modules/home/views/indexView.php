        ...
        <div class="row invoice-card-row">
                ...
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Tổng số hoá đơn</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Hoá đơn đã thanh toán</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-xxl-6 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        <div class="icon me-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="33px" height="32px">
                                <path fill="rgb(255, 255, 255)" d="M326.3 218.8c0 20.5-16.7 37.2-37.2 37.2h-70.3v-74.4h70.3c20.5 0 37.2 16.7 37.2 37.2zM504 256c0 137-111 248-248 248S8 393 8 256 119 8 256 8s248 111 248 248zm-128.1-37.2c0-47.9-38.9-86.8-86.8-86.8H169.2v248h49.6v-74.4h70.3c47.9 0 86.8-38.9 86.8-86.8z" />
                            </svg>
                        </div>
                        <div>
                            <h2 class="text-white invoice-num"><?php echo $count_product ?></h2>
                            <span class="text-white fs-18">Số lượng sản phẩm</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-xxl-6 col-sm-6">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        <div class="icon me-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="33px" height="32px">
                                <path fill="rgb(255, 255, 255)" d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" />
                            </svg>
                        </div>
                        <div>
                            <h2 class="text-white invoice-num"><?php echo $count_post ?></h2>
                            <span class="text-white fs-18">Số lượng bài viết</span>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo date_time_format($post
                                                ['post_date_update']) ?></td>
                                                
                                                <td><?php if ($post['post_status'] == 0) { ?>
