    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?mod=slider&action=addSlider">Thêm slider</a></li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-3">Thêm slider mới</h4>
                        <form class="needs-validation" novalidate="" enctype="multipart/form-data" method="POST">
                            <div class="mb-3">
                                <label for="slider-title" class="form-label">Tiêu đề</label>
                                <input 
                                    type="text" 
                                    class="form-control" 
                                    id="slider-title" 
                            ...
                            <div class="mb-3">
                                <label for="slider-title" class="form-label">Mô tả</label>
                                <input 
                                    type="text" 
                                    class="form-control" 
                                    id="slider-title" 
                            ...
                            <div class="mb-3">
                                <label for="slider-title" class="form-label">Chữ nút</label>
                                <input 
                                    type="text" 
                                    class="form-control" 
                                    id="slider-title" 
                            ...
                            <div class="mb-3">
                                <label for="slider-title" class="form-label">URL</label>
                                <input 
                                    type="text" 
                                    class="form-control" 
                                    id="slider-title" 
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="form-file">
                                        <input type="file" name="file" id="post-thumb" class="form-file-input form-control">
                                    </div>
                                </div>
                            </div>
