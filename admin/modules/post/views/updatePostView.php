    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?mod=post&action=addPost">Cập nhật</a></li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-3">Cập nhật bài viết</h4>
                        <form class="needs-validation" novalidate="" enctype="multipart/form-data" method="POST">
                            <div class="mb-3">
                                ...
                                <input 
                                    ...
                                    name="post-title"
                                    value="<?php 
                                        if (!empty($_POST['post-title'])) echo $_POST['post-title'];
                                        else if (!empty($post['post_title'])) echo $post['post_title'];
                                    ?>"
                                >
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="post-desc">Mô tả ngắn</label>
                                <div class="col-lg-6">
                                    <textarea 
                                        class="form-control" 
                                        id="post-desc" 
                                        ...
                                        name="post-desc"
                                        ><?php 
                                            if (!empty($_POST['post-desc'])) echo $_POST['post-desc'];
                                            else if (!empty($post['post_desc'])) echo $post['post_desc']; 
                                        ?></textarea>
                                    <div class="invalid-feedback show-error">
                                        <?php
                            ...
                            <div class="mb-3">
                                <label for="post-content" class="form-label">Chi tiết bài viết</label>
                                <textarea 
                                    name="post-content" 
                                    class="ckeditor"
                                    ><?php 
                                        if (!empty($_POST['post-content'])) echo $_POST['post-content'];
                                        else if (!empty($post['post_content'])) echo $post['post_content'];
                                    ?></textarea>
                                <div class="invalid-feedback show-error">
                                    <?php
