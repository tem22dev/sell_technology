    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?mod=product&action=addProduct">Cập nhật sản phẩm</a></li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-3">Cập nhật sản phẩm</h4>
                        <form class="needs-validation" novalidate="" enctype="multipart/form-data" method="POST">
                            <div class="mb-3">
                                ...
                                <input 
                                    ...
                                    name="product-name"
                                    value="<?php 
                                        if (!empty($_POST['product-name'])) echo $_POST['product-name'];
                                        else if (!empty($product['product_name'])) echo $product['product_name'];
                                    ?>"
                                >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input 
                                    ...
                                    value="<?php 
                                        if (!empty($_POST['product-price'])) echo $_POST['product-price'];
                                        else if (!empty($product['product_price_old'])) echo $product['product_price_old']; 
                                    ?>"
                                >
                                <div class="invalid-feedback show-error">
                                    <?php
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input 
                                    ...
                                    value="<?php 
                                        if (!empty($_POST['product-price-new'])) echo $_POST['product-price-new'] ;
                                        else if (!empty($product['product_price_new'])) echo $product['product_price_new'];
                                    ?>"
                                >
                                <div class="invalid-feedback show-error">
                                    <?php
                            ...
                            <div class="mb-3">
                                ...
                                <textarea 
                                    ...
                                    class="ckeditor"
                                ><?php 
                                    if (!empty($_POST['product-config'])) echo $_POST['product-config'];
                                    else if (!empty($product['product_config'])) echo $product['product_config'];
                                ?></textarea>
                                <div class="invalid-feedback show-error">
                                    <?php
                            ...
                            <div class="mb-3">
                                ...
                                <textarea 
                                    ...
                                    class="ckeditor"
                                ><?php 
                                    if (!empty($_POST['product-content'])) echo $_POST['product-content'];
                                    else if (!empty($product['product_content'])) echo $product['product_content']; 
                                ?></textarea>
                                <div class="invalid-feedback show-error">
                                    <?php
                            ...
                            <div class="mb-3 col-md-2">
                                ...
                                <input 
                                    ...
                                    min="0"
                                    value="<?php 
                                        if (!empty($_POST['product-quantity'])) echo $_POST['product-quantity'];
                                        else if (!empty($product['product_quantity'])) echo $product['product_quantity'];
                                    ?>"
                                >
                                <div class="invalid-feedback show-error">
                                    <?php
