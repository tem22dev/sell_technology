...
<html lang="en">
	<head>
		...
		<!-- Data table -->
		<link href="./public/vendor/datatables/css/style.css" rel="stylesheet">
		<!-- Custom Stylesheet -->
							...
							<ul class="navbar-nav header-right">
								...
								<li class="nav-item dropdown notification_dropdown">
									...
									<svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<span class="badge light text-white bg-primary rounded-circle d-flex align-items-center justify-content-center">12</span>
									</a>
								...
								<li class="nav-item dropdown notification_dropdown">
									...
									<svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<span class="badge light text-white bg-primary rounded-circle d-flex align-items-center justify-content-center">5</span>
									</a>
									<div class="dropdown-menu dropdown-menu-end">
										<div id="dlab_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
											<ul class="timeline">
