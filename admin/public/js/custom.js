    ...
    return {
        init: function () {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(),
                ...
                jQuery(".show-pass-new").on("click", function () {
                    jQuery(this).toggleClass("active"),
                        "password" == jQuery("#dlab-password-new").attr("type") ? jQuery("#dlab-password-new").attr("type", "text") : "text" == jQuery("#dlab-password-new").attr("type") && jQuery("#dlab-password-new").attr("type", "password");
                }),
                jQuery(".show-repass-new").on("click", function () {
                    jQuery(this).toggleClass("active"),
                        "password" == jQuery("#dlab-repassword-new").attr("type") ? jQuery("#dlab-repassword-new").attr("type", "text") : "text" == jQuery("#dlab-repassword-new").attr("type") && jQuery("#dlab-repassword-new").attr("type", "password");
                }),
